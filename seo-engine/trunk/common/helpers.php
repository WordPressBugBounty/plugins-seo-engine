...
if ( !class_exists( 'MeowKit_MWSEO_Helpers' ) ) {

  class MeowKit_MWSEO_Helpers {
    //public static $version = MeowKit_MWSEO_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MWSEO_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MWSEO_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MWSEO_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MWSEO_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MWSEO_Helpers::$startQueries[ $timerName ];
  ...
  // if ( MeowKit_MWSEO_Helpers::is_rest() ) {
